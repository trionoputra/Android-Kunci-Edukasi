...
public class NumberOfQuestionDialog extends DialogFragment {
	@Override
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View v = inflater.inflate(R.layout.view_numberofquestion, null);
		builder.setView(v);
		...
		number.setText(Shared.read(Constants.SETTING_NUMBER_OF_QUESTION, "10"));
		...
		ok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Shared.write(Constants.SETTING_NUMBER_OF_QUESTION, nb);
				if(Integer.valueOf(nb) < Integer.valueOf(Shared.read(Constants.SETTING_NUMBER_OF_GOALS, "10")))
				{
					Shared.write(Constants.SETTING_NUMBER_OF_GOALS, nb);
					TextView txtgoal = (TextView)getActivity().findViewById(R.id.txtnumberofgoal);
					txtgoal.setText(nb);
					
				}
				
				TextView txtnumber = (TextView)getActivity().findViewById(R.id.txtnumberofquestion);
